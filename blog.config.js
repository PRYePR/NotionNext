...
const BLOG = {
  AUTHOR: '奥地利全攻略', // 作者
  BIO: '留学奥地利生活必备网站', // 作者简介
  LINK: 'https://info.moreyu.com', // 网站地址
  KEYWORDS: 'Notion, 攻略', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'd442a56f9bc24294be851de315183fab', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'support@moreyu.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '奥地利全攻略', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '留学奥地利生活必备网站', // 站点描述，被notion中的页面描述覆盖
